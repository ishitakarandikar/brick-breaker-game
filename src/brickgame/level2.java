...
public level2(int score1, String unamee){                                                        // constructor
   oldscore=score1;
    score=score1;     
    Rectangle[] brick =new Rectangle[200];   
    bricks = new int[columns][rows];
     Rectangle[] brick1 =new Rectangle[200];   
    bricks1 = new int[columns][rows];
        ...
        usrname=unamee;
        System.out.println(usrname+ " level2 ");
    }
...
private void win(Graphics g) {
      ...
      //  newscore=oldscore+score;
        ...
        addd a= new addd();                                           // if there are no bricks u won
           a.add(score ,usrname);
       level3 l= new level3(score,usrname);
       l.ll(usrname);
      // l.play(unamee);
       // for (int i =0;i<columns;i++){
         //   Arrays.fill(bricks[i],1);
...
private void drawbricks(Graphics g) {
        ...
        { Random rand = new Random();
            ...
            {      if(bricks[i][j]>0){
                g.setColor(randomcolor);
                    g.fillRect(140 + i * brick_width + i * 5, 80 + j * brick_height + j * 2, brick_width, brick_height);
                    g.setColor(Color.white);
                    g.drawRect(140 + i * brick_width + i * 5, 80 + j * brick_height + j * 2, brick_width, brick_height);// print star
            }     }      
             for(int j=0; j<=rows-i-1; j++) //  inner loop for columns
            {      if(bricks1[i][j]>0){
                g.setColor(randomcolor);
                    g.fillRect(380 + i * brick_width + i * 5, 80 + j * brick_height + j * 2, brick_width, brick_height);
                    g.setColor(Color.white);
                    g.drawRect(380 + i * brick_width + i * 5, 80 + j * brick_height + j * 2, brick_width, brick_height);// print star
            }     
       }
        }
  ...
  //  for(int j=0; j<=i; j++) //  inner loop for columns
    //        {   
      //          g.setColor(white);
        //            g.fillRect(0 + i * brick_width + i * 5, 0 + j * brick_height + j * 2, brick_width, brick_height);
          //          g.setColor(Color.white);
            //        g.drawRect(0 + i * brick_width + i * 5, 0 + j * brick_height + j * 2, brick_width, brick_height);// print star
              //     }
  //  System.out.println("\n");
        ...
        A:for (int i=0; i<rows; i++){
            ...
            B:  for (int j =0; j<=i ;j++){
               if (bricks[i][j]>0) {
                    ...
                    int brick_X_pos = 140 + i * brick_width + i * 5;
            ...
            C:  for(int j=0; j<=rows-i-1; j++)
            {
            if(bricks1[i][j]>0){
                    int brick_X_pos = 380 + i * brick_width + i * 5;
                    int brick_Y_pos = 80 + j * brick_height + j * 2;
                    Rectangle brick_rect = new Rectangle(brick_X_pos, brick_Y_pos, brick_width, brick_height);
                    if (ball_rect.intersects(brick_rect)) {
                        bricks1[i][j] = 0;
...
//       frame.setResizable(false);
  //     frame.setBounds(100,20,800,660);
    ...
    //}
    public void play(String unamee)
    {
     JFrame frame = new JFrame();
       
       
       level2 g = new level2(score,unamee);
       frame.setResizable(false);
       frame.setBounds(100,20,800,660);
       frame.setTitle("Brick Game");
       frame.add(g);
